...
int dataPins[NUM_STRIPS] = {9, 10, 11, 12};  // Adjust the data pins according to your setup
int numLeds[NUM_STRIPS] = {30, 30, 30, 30};  // Example: 30 LEDs on each strip
...
void initialize_leds() {
    for (int i = 0; i < NUM_STRIPS; i++) {
        ...
        if (i == 0) {
            ...
            FastLED.addLeds<WS2812B, DATA_PIN_4, RGB>(leds[i], numLeds[i]);
        }
    }
